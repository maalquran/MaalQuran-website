...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Detail");                                                                // Line 236
	echo T_("Status");                                                                // Line 59
	echo T_("Date");                                                                  // Line 143
	...
	echo T_("User");                                                                  // Line 67
	echo T_("Agent");                                                                 // Line 46
	echo T_("User id");                                                               // Line 27
	echo T_("User logs");                                                             // Line 34
	...
	echo T_("What do you want to send to this user?");                                // Line 13
	...
	echo T_("Plus");                                                                  // Line 19
	echo T_("Minus");                                                                 // Line 20
	echo T_("Budget before");                                                         // Line 81
	echo T_("Budget");                                                                // Line 58
	echo T_("Condition");                                                             // Line 59
	echo T_("Try to start with add new :transactions!");                              // Line 115

	//---------------------------------addons/content_su/transactions/add/display.html
	echo T_("type");                                                                  // Line 22
	echo T_("Money");                                                                 // Line 45
	echo T_("Gift");                                                                  // Line 46
	echo T_("Transfer");                                                              // Line 47
	echo T_("Prize");                                                                 // Line 48
	echo T_("Unit");                                                                  // Line 56
	echo T_("Toman");                                                                 // Line 64
	echo T_("$");                                                                     // Line 60
	...
	echo T_("Contact the support team right now.");                                   // Line 129
	echo T_("Contact the legendary support team right now.");                         // Line 131
	...
	echo T_("Get android detail");                                                    // Line 5
